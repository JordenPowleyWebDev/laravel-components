...
var Button = function Button(props) {
  ...
  var renderHrefButton = function renderHrefButton(href, target) {
  ...
  switch (type) {
    case BUTTON_TYPES.HREF:
      return renderHrefButton(!!options && !!options.href ? options.href : "", !!options && !!options.target ? options.target : null);

    case BUTTON_TYPES.MODAL:
      return renderModalButton(!!options && !!options.modal ? options.modal : "");

    case BUTTON_TYPES.ON_CLICK:
      return renderOnClickButton(!!options && !!options.on_click ? options.on_click : function () {});

    case BUTTON_TYPES.SUBMIT:
      return renderSubmitButton(!!options && !!options.form ? options.form : null);
  }
};
